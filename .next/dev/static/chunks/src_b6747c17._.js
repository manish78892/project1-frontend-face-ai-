...
"[project]/src/app/admin/leave-management/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AdminRoute$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/AdminRoute.js [app-client] (ecmascript)"); // adjust path if needed
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function LeaveManagementContent() {
    ...
    const handleAction = async (leaveId, status)=>{
        ...
        try {
            const res_0 = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/admin/leaves/${leaveId}`, {
                method: 'PUT',
                headers: {
    ...
    const handleDelete = async (leaveId_0)=>{
        if (!confirm("Are you sure you want to permanently delete this leave request?")) return;
        setDeletingId(leaveId_0);
        const token_1 = localStorage.getItem('token');
        try {
            const res_1 = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000")}/api/admin/leaves/${leaveId_0}`, {
                method: 'DELETE',
                headers: {
            ...
            if (res_1.ok) {
                setLeaves(leaves.filter((l_0)=>l_0._id !== leaveId_0));
            } else {
                const err = await res_1.json();
    ...
    const formatDateTime = (dateString_0)=>{
        const date_0 = new Date(dateString_0);
        return date_0.toLocaleDateString('en-IN', {
            day: 'numeric',
            month: 'short',
            year: 'numeric',
            hour: '2-digit',
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        lineNumber: 138,
                        columnNumber: 22
                    }, this) : leaves.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-4",
                        children: leaves.map((leave)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(LeaveManagementContent, "DBtcTVFjdmdVVABOVW5I0FZ8WfQ=");
_c = LeaveManagementContent;
function Page() {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(2);
    if ($[0] !== "030510b77295a651778c0717302be5b44c892c95153c95a5b92e79481a917c38") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "030510b77295a651778c0717302be5b44c892c95153c95a5b92e79481a917c38";
    }
    let t0;
...
//# sourceMappingURL=src_b6747c17._.js.map